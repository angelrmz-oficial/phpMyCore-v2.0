...
<html lang="en">
  <head>
    ...
    <title>Settings &mdash; TheAdmin Invoicer</title>
    <!-- Styles -->
      ...
      <div class="main-content">
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="card">
              <ul class="nav nav-lg nav-pills flex-column">
                <li class="nav-item">
                  <a class="nav-link active" href="#tab1" data-toggle="tab">Company Details</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#tab2" data-toggle="tab">User Details</a>
                </li>
                <li class="nav-item">
          ...
          <div class="col-lg-9 tab-content">
            <form class="card form-type-material tab-pane fade active show" id="tab1">
              <h4 class="card-title fw-400">Company Details</h4>

              <div class="card-body">
                <div class="flexbox gap-items-4">
                  <img class="avatar avatar-xl" src="assets/img/logo-thetheme.png" alt="...">
            ...
            <form class="card form-type-material tab-pane fade" id="tab2">
