...
<html lang="en">
  ...
  <body>
        ...
        <div class="media-list media-list-divided media-list-hover" data-provide="selectall">
          ...
          <div class="media-list-body bg-white b-1">
            <div class="media align-items-center">
              ...
              <span class="lead text-fade mr-25 d-none d-md-block" title="Balance" data-provide="tooltip">$2,500</span>
            ...
            <div class="media align-items-center">
              ...
              <a class="flexbox align-items-center flex-grow gap-items" href="#qv-user-details" data-toggle="quickview">
                ...
                <div class="media-body text-truncate">
                  <h6>Hossein Shams</h6>
                  <small>
                    <span>hossein.shams@yahoo.com</span>
                    <span class="divider-dash">(256) 875-6579</span>
                  </small>
                </div>
              </a>

              <span class="lead text-fade mr-25 d-none d-md-block" title="Balance" data-provide="tooltip">$1,450</span>
            ...
            <div class="media align-items-center">
              ...
              <a class="flexbox align-items-center flex-grow gap-items" href="#qv-user-details" data-toggle="quickview">
                ...
                <div class="media-body text-truncate">
                  <h6>Sarah Conner</h6>
                  <small>
                    <span>sarah.conner84@gmail.com</span>
                    <span class="divider-dash">(325) 987-6541</span>
                  </small>
                </div>
              </a>

              <span class="lead text-fade mr-25 d-none d-md-block" title="Balance" data-provide="tooltip">$500</span>
            ...
            <div class="media align-items-center">
              ...
              <a class="flexbox align-items-center flex-grow gap-items" href="#qv-user-details" data-toggle="quickview">
                ...
                <div class="media-body text-truncate">
                  <h6>Frank Camly</h6>
                  <small>
                    <span>f.camly@hotmail.com</span>
                    <span class="divider-dash">(986) 355-3125</span>
                  </small>
                </div>
              </a>

              <span class="lead text-fade mr-25 d-none d-md-block" title="Balance" data-provide="tooltip">$960</span>
            ...
            <div class="media align-items-center">
              ...
              <a class="flexbox align-items-center flex-grow gap-items" href="#qv-user-details" data-toggle="quickview">
                ...
                <div class="media-body text-truncate">
                  <h6>Garret Gloss</h6>
                  <small>
                    <span>garret.gloss24@gmail.com</span>
                    <span class="divider-dash">(321) 456-7980</span>
                  </small>
                </div>
              </a>

              <span class="lead text-fade mr-25 d-none d-md-block" title="Balance" data-provide="tooltip">$3,680</span>
            ...
            <div class="media align-items-center">
              ...
              <a class="flexbox align-items-center flex-grow gap-items" href="#qv-user-details" data-toggle="quickview">
                ...
                <div class="media-body text-truncate">
                  <h6>Bobby Mincy</h6>
                  <small>
                    <span>bob.minc@gmail.com</span>
                    <span class="divider-dash">(695) 123-3698</span>
                  </small>
                </div>
              </a>

              <span class="lead text-fade mr-25 d-none d-md-block" title="Balance" data-provide="tooltip">$0</span>
            ...
            <div class="media align-items-center">
              ...
              <a class="flexbox align-items-center flex-grow gap-items" href="#qv-user-details" data-toggle="quickview">
                ...
                <div class="media-body text-truncate">
                  <h6>Garry Camara</h6>
                  <small>
                    <span>garry.camara@gmail.com</span>
                    <span class="divider-dash">(698) 986-3651</span>
                  </small>
                </div>
              </a>

              <span class="lead text-fade mr-25 d-none d-md-block" title="Balance" data-provide="tooltip">$2,300</span>
            ...
            <div class="media align-items-center">
              ...
              <a class="flexbox align-items-center flex-grow gap-items" href="#qv-user-details" data-toggle="quickview">
                ...
                <div class="media-body text-truncate">
                  <h6>Fidel Tonn</h6>
                  <small>
                    <span>f.tonn@thetheme.io</span>
                    <span class="divider-dash">(511) 986-3579</span>
                  </small>
                </div>
              </a>

              <span class="lead text-fade mr-25 d-none d-md-block" title="Balance" data-provide="tooltip">$1,100</span>
    ...
    <div class="fab fab-fixed">
      <a class="btn btn-float btn-primary" href="#qv-user-add" title="New Client" data-provide="tooltip" data-toggle="quickview"><i class="ti-plus"></i></a>
    </div>
