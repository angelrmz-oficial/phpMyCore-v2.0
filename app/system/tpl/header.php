...
<header class="topbar">
      ...
      <div class="topbar-right">
        ...
        <ul class="topbar-btns">
          <li class="dropdown">
            <span class="topbar-btn" data-toggle="dropdown"><img class="avatar" src="assets/img/user-default.png" alt="..."></span>
            <div class="dropdown-menu dropdown-menu-right">
              <!-- <a class="dropdown-item" href="#"><i class="ti-user"></i> Profile</a>
              <a class="dropdown-item" href="#"><i class="ti-settings"></i> Settings</a> -->
              <a class="dropdown-item" href="https://pmc.angelrmz.com/docs?help=dashboard" target="_blank"><i class="ti-help"></i> Help</a>
