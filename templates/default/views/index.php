...
<head>
    ...
    <!-- Hello world! my first app // web app // web site // web proyect -->
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0 is-revealing">Hello World!</h1>
	                        <p class="hero-paragraph is-revealing">You can start developing your web application project from the web manager</p>
							<div class="hero-form field field-grouped is-revealing">
	                            ...
	                            <div class="control">
	                                <a class="button button-primary button-block" href="<?= site_url; ?>/app/system/">Web Manager</a>
	                            </div>
	                        </div>
						</div>
	                        ...
	                        <div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Release Notes</h4>
									</div>
	                                <p class="text-sm mb-0">phpMyCore has been installed successfully.</p>
	                            </div>
	                        </div>
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Coming soon!</h4>
									</div>
	                                <p class="text-sm mb-0">This website (<?= site_name; ?>) is currently under construction</p>
	                            </div>
	                        </div>
							<div class="feature">
	                            <div class="feature-inner">
        ...
        <footer class="site-footer">
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="footer-copyright">Copyright &copy; 2021 phpMyCore | Version <?= system_version; ?></div>
                </div>
            </div>
        </footer>
    </div>

    <script src="{assets}/landing/js/main.min.js"></script>
</body>
</html>
